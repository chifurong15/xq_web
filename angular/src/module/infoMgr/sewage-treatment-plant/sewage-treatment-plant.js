  ...
  angular
    ...
    .controller(
      'sewageTreatment', [
        ...
        'myStorage',
        '$http',
        function sewageTreatment($localStorage, $scope, $location, $log, $q, $rootScope, globalParam, $window, routeService,
          ...
          var reGetProducts = function() {
            $http({
              ...
              params: {
                ...
                mainclassids: '80000000000000000000000000000000',//部件大类，硬编码 ，污水处理厂
                subclassids: '80010000000000000000000000000000',// 部件小类
