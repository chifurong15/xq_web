...
(function(window, angular) {
  ...
  angular.module("app").controller('sewageTreatmentDetail', [
    '$localStorage',
    '$scope',
    '$location',
    '$log',
    ...
    'moduleService',
    '$http',
    function sewageTreatmentDetail($localStorage, $scope, $location, $log, $q, $rootScope, globalParam, $window, routeService, moduleService, $http) {
