...
(function(window, angular) {
    ...
    angular.module("app").controller(
        'pondEditCtrl', ['$localStorage','$scope','routeService','moduleService','$http','MapUtil','OneMapqueryAdminregionFromMysql',
                function pondEditCtrl($localStorage, $scope, routeService,moduleService, $http, MapUtil, OneMapqueryAdminregionFromMysql) {
                    if(!$localStorage.pondEditData){
                        layer.msg('获取数据失败,请重试');
                        return;
                    }
                    $scope.pond = $localStorage.pondEditData;
