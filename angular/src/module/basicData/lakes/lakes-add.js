...
(function(window, angular) {
	...
	angular.module("app").controller(
			'lakesAddCtrl', ['$localStorage','$scope','routeService','moduleService','$http','MapUtil','OneMapqueryAdminregionFromMysql',
				function lakesAddCtrl($localStorage, $scope, routeService,moduleService, $http, MapUtil, OneMapqueryAdminregionFromMysql) {
					$scope.lake = {};

					//判断名称是否重复
                    $scope.isRepeat = function(){
                        if(!$scope.lake.lakesName){
                            return;
                        }
                        $http({
                            method:'get',
					...
					$scope.submit = function() {
                        ...
                        $http({
							method: "post",
							url: moduleService.getServiceUrl() + lakesUrl + "/add",
							data: {
                                ...
                                throughArea: $scope.lake.throughArea,
