    ...
    angular
        ...
        .controller(
            ...
            [
                ...
                'moduleService',
                'globalParam',
                function reportProblemStatistics($localStorage, $scope,
                    ...
                    function getList () {
                        ...
                        $ajaxhttp.myhttp({
                            url: apiPrefix + '/v1/supervise/evaluateList',
                            method: 'get',
                            params: params,
                    ...
                    $scope.export = function (){
                        window.open(
                            apiPrefix
                            + '/v1/supervise/createExcelEvaluate?statTime='
                            + $scope.startTime
                            + '&endTime='
                            + $scope.endTime
                            + '&regionid='
