...
(function(window, angular) {
    ...
    angular.module("app").controller('imComponentEdit', [
        '$localStorage',
        '$scope',
        '$location',
        '$log',
        ...
        function imComponentEdit($localStorage, $scope, $location, $log, $q, $rootScope, globalParam, $window, routeService, moduleService, $http, MapUtil, ComponentManagerService, OneMapqueryAdminregionFromMysql) {
