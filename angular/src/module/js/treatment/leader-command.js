	...
	angular
			...
			.controller(
					...
					[
							...
							'routeService',
							'$http',
							function leaderCommand($localStorage, $scope, $location,
										...
										.mock(
												'http://f.cn',
												{
													'data' : {
														...
														'records|10' : [ {
															'id' : '@id',
															'eventResource|1' : [ "河长APP", "电话上报",  "公众APP",  "微信",  "曝光台", "钉钉平台" ],
															'eventRegion|1' : [ "杭州市",
																	"绍兴市",
																	"宁波市",
																	"金华市",
								...
								Mock.mock('http://d.com', 'post',
										function(options) {
											var id = parseInt(options.body
													.split("=")[1])// 获取删除的id
											var index;
											// for(var i in arr){
