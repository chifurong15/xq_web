...
(function(window, angular) {
	...
	angular.module("app").controller(
			...
			[
					...
					'routeService',
					'$http',
					function imReachAdd($localStorage, $scope, $location, $log,$q, $rootScope,globalParam, $window, routeService, $http) {
...
//			                		 return;
                        ...
                        $scope.parentReach = function(){
                            $http({
                                method: "get",
                                url: $localStorage.serviceUrl_watersource + reachUrl + "/parentReach",
                                params: {
                                    grade: $scope.river_part.dictValue,
						...
						$scope.quality_Change = function(water_quality) {
						    if (water_quality == null){
                                ...
                                $scope.quality_Change_name = water_quality.dictName;
                                $scope.quality_Change_value = water_quality.dictValue;
						...
						$scope.deposit_Change = function(deposit_status) {
						    if (deposit_status == null){
                                ...
                                $scope.deposit_Change_name = deposit_status.dictName;
                                $scope.deposit_Change_value = deposit_status.dictValue;
						...
						$scope.wm_Change = function(whether_mountain) {
						    if (whether_mountain == null){
                                ...
                                $scope.wm_Change_name = whether_mountain.dictName;
                                $scope.wm_Change_value = whether_mountain.dictValue;
						...
						$scope.wv_Change = function(whether_virtual) {
						    if (whether_virtual == null){
                                ...
                                $scope.wv_Change_name = whether_virtual.dictName;
                                $scope.wv_Change_value = whether_virtual.dictValue;
						...
						$scope.rs_Change = function(river_shore) {
						    if (river_shore == null){
                                ...
                                $scope.rs_Change_name = river_shore.dictName;
                                $scope.rs_Change_value = river_shore.dictValue;
						...
						$scope.ls_Change = function(lakes_shore) {
						    if (lakes_shore == null){
                                ...
                                $scope.ls_Change_name = lakes_shore.dictName;
                                $scope.ls_Change_value = lakes_shore.dictValue;
						...
						$scope.res_Change = function(reservoir_shore) {
							$scope.res_Change_name = reservoir_shore.dictName;
							$scope.res_Change_value = reservoir_shore.dictValue;
...
//						}
                        ...
                        $scope.adminTree = function () {
                            ...
                            var regionAndUserTreeUrl = $localStorage.serviceUrl_watersource + reachUrl + "/regionAndUserTree";
                        ...
                        $scope.select_one = function () {
                            $http({
                                method: "GET",
                                url: $localStorage.serviceUrl_watersource + reachUrl + "/findByUser",
                                params: {
                        ...
                        function zTreeOnExpand(treeId, treeNode) {
                            ...
                            $http({
                                method: "GET",
                                url: $localStorage.serviceUrl_watersource + reachUrl + "/regionAndUserTree",
                                params: {
                                    parentCode: treeNode.id
                                },
                            }).success(
                        ...
                        // $scope.dutyLevel = function () {
                         //    $http({
                         //        method: "get",
                         //        url: $localStorage.serviceUrl_watersource +serviceUrl_watersource + "/smDictionary/findDictionary",
                         //        params: {
                         //            type: 1
                         //        }
                         //    }).success(
						...
						$scope.level_Change = function(d_Level) {
                            if (d_Level == null){
                                ...
                                $scope.level_Change_value = d_Level.dictValue;
                                console.log($scope.level_Change_name);
                                console.log($scope.level_Change_value);
                                $scope.level_Change_name = d_Level.dictName;
                            }
                        }
						...
						$scope.dutyType_Change = function(d_Level) {
                            if (d_Level == null){
                                ...
                                $scope.dutyType_Change_name = d_Level.dictName;
                                $scope.dutyType_Change_value = d_Level.dictValue;
						...
						$scope.side_Change = function(d_Level) {
                            if (d_Level == null){
                                ...
                                $scope.side_Change_name = d_Level.dictName;
                                $scope.side_Change_value = d_Level.dictValue;
						...
						$scope.add = function() {
                            ...
                            if(!$scope.reachFName || !jsname.test($scope.reachFName) == null) {
                                ...
                                if (!$scope.alias) {
                                ...
                                } else if (!$scope.dutyLevels.dictValue) {
                                    layer.alert("请完善履职级别", {
                                        skin: 'my-skin',
                                        closeBtn: 1,
                                        anim: 3
                                    });
                                } else if (!$scope.dutyTypes.dictValue) {
                                    layer.alert("请完善履职类型", {
                                        skin: 'my-skin',
                                        closeBtn: 1,
                                        anim: 3
                                    });
                                } else if (!$scope.bankSides.dictValue) {
                                    layer.alert("请完善管理岸面", {
                                        skin: 'my-skin',
                                        closeBtn: 1,
                                        anim: 3
                                    ...
                                    $http({
                                        method: "post",
                                        url: $localStorage.serviceUrl_watersource +reachUrl + "/add",
                                        params: {
                                ...
                                if (!$scope.alias) {
                                    ...
                                    $http({
                                        ...
                                        method: "post",
                                        url: $localStorage.serviceUrl_watersource +reachUrl + "/v1/add",
                                        params: {
                                            reachName: $scope.reachFName,
                                            alias: $scope.alias,
                                            waterGrade: $scope.quality_Change_value,
