	...
	angular.module("app")
		.controller(
			'lakesAddCtrl', [
				...
				'routeService',
				'$http',
				function lakesAddCtrl($localStorage, $scope,$location, $log, $q, $rootScope, $window,routeService, $http) {
					...
					$scope.shore_Change = function(shore_type) {
					    if (shore_type == null){
                            $scope.shore_Change_name = null;
                            $scope.shore_Change_id = null;
                            $scope.shore_Change_dictValue = null;
                        } else {

                            $scope.shore_Change_name = shore_type.dictName;
                            $scope.shore_Change_id = shore_type.id;
                            $scope.shore_Change_dictValue = shore_type.dictValue;
                            console.log($scope.shore_Change_dictValue);
                            console.log($scope.shore_Change_name);
                            console.log($scope.shore_Change_id);
                        }
					}
					...
					$scope.submit = function() {
						...
						if(!$scope.lakesName || !jsname.test($scope.lakesName) == null) {
                        ...
                        } else if (!$scope.lake_type){
                            layer.alert("请完善湖泊类型", {
                                skin: 'my-skin',
                                closeBtn: 1,
                                anim: 3
                            });
                        } else if (!$scope.shore_type){
                            layer.alert("请完善湖泊岸别", {
                                skin: 'my-skin',
                                closeBtn: 1,
                                anim: 3
							...
							$http({
								method: "post",
								url: $localStorage.serviceUrl +lakesUrl + "/add",
								params: {
